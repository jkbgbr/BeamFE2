...
class ModalSolver(Solver):
    ...
    def solve(self):
        ...
        # check if it makes sense to even start
        massmatrix = structure.M_with_masses
...
class LinearStaticSolver(Solver):
    def __init__(self, structure=None):
        super(LinearStaticSolver, self).__init__(structure)
...
class BucklingSolver(Solver):
    def __init__(self, structure=None):
        super(BucklingSolver, self).__init__(structure)
        self.nr_modes = 1
